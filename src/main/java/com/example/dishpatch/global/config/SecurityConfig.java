    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtUtil jwtUtil) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasRole("CEO")
                        .requestMatchers(HttpMethod.POST, "/ceoReviews/{reviewId}").hasRole("CEO")
                        .requestMatchers(HttpMethod.PATCH, "/ceoReviews/{ceoReviewId}").hasRole("CEO")
                        .requestMatchers(HttpMethod.DELETE, "/reviews/{reviewId}").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/ceoReviews/{ceoReviewId}", "/stores/{storeId}").hasAnyRole("CEO", "ADMIN")
